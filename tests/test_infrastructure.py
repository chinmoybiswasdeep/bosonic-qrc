...
from bosonic_qrc_cv.aggregate import aggregate
from bosonic_qrc_cv.infrastructure import ResultJournal, RunKey, canonical_hash
...
def test_shard_merge_is_complete_and_deterministic(tmp_path):
    config = {
        ...
        "seeds": {"reservoir": [1, 2], "data": [4], "measurement": [3]},
    }
    ...
    for index, shard in enumerate(shards, start=1):
        ...
        journal.append(RunKey(index, 4, 3, "cv_qrc"), {"rows": []})
