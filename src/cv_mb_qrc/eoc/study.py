...
from .interacting import InteractingMBReservoir, MBFockConfig
...
def _open_scan(raw, boundaries):
    ...
    for interaction in raw["open_system"]["interactions"]:
        ...
        first = InteractingMBReservoir(settings)
        second = InteractingMBReservoir(settings)
        features = []
        distances = []
        ...
        rows.append(
            {
                ...
                "retained_input_norm": diagnostics.get("minimum_retained_norm"),
        ...
        rows.append(
            {
                ...
                "retained_norm": last["diagnostics"]["minimum_retained_norm"],
            }
        )
    return rows
    ...
    *,
    ...
    manifest = {
        ...
        "dependencies": {
            ...
            for package in ("numpy", "scipy", "matplotlib", "PyYAML", "photographiq")
        },
    }
    checksums = {}
